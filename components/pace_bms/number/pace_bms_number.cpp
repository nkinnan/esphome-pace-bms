...
void PaceBmsNumber::setup() {
	if (this->parent_->get_protocol_commandset() == 0x25) {
		...
		if (this->cell_over_voltage_alarm_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->cell_over_voltage_protection_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->cell_over_voltage_protection_release_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->cell_over_voltage_protection_delay_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->pack_over_voltage_alarm_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->pack_over_voltage_protection_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->pack_over_voltage_protection_release_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->pack_over_voltage_protection_delay_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->cell_under_voltage_alarm_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->cell_under_voltage_protection_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->cell_under_voltage_protection_release_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->cell_under_voltage_protection_delay_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->pack_under_voltage_alarm_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->pack_under_voltage_protection_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->pack_under_voltage_protection_release_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->pack_under_voltage_protection_delay_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->charge_over_current_alarm_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->charge_over_current_protection_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->charge_over_current_protection_delay_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->discharge_over_current1_alarm_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->discharge_over_current1_protection_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->discharge_over_current1_protection_delay_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->discharge_over_current2_protection_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->discharge_over_current2_protection_delay_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->short_circuit_protection_delay_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
			this->short_circuit_protection_delay_number_->add_on_control_callback([this](float value) {
				...
				this->parent_->write_short_circuit_protection_configuration_v25(this->short_circuit_protection_configuration_);
			});
		}
		...
		if (this->cell_balancing_threshold_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->cell_balancing_delta_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->sleep_cell_voltage_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->sleep_delay_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->full_charge_voltage_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->full_charge_amps_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->low_charge_alarm_percent_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->charge_over_temperature_alarm_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->charge_over_temperature_protection_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->charge_over_temperature_protection_release_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->discharge_over_temperature_alarm_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->discharge_over_temperature_protection_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->discharge_over_temperature_protection_release_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->charge_under_temperature_alarm_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->charge_under_temperature_protection_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->charge_under_temperature_protection_release_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->discharge_under_temperature_alarm_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->discharge_under_temperature_protection_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->discharge_under_temperature_protection_release_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->mosfet_over_temperature_alarm_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->mosfet_over_temperature_protection_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->mosfet_over_temperature_protection_release_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->environment_under_temperature_alarm_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->environment_under_temperature_protection_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->environment_under_temperature_protection_release_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->environment_over_temperature_alarm_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->environment_over_temperature_protection_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->environment_over_temperature_protection_release_number_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
