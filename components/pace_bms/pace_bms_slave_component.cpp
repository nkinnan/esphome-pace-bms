...
void PaceBmsSlave::register_mosfet_over_temperature_configuration_callback_v25(std::function<void(PaceBmsProtocolV25::MosfetOverTemperatureConfiguration&)> callback) { this->parent_->register_charge_and_discharge_under_temperature_configuration_callback_v25(callback); }
...
void PaceBmsSlave::register_system_datetime_callback_v25(std::function<void(PaceBmsProtocolV25::DateTime&)> callback) { this->parent_->register_system_datetime_callback_v25(); }
