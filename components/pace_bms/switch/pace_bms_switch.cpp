...
void PaceBmsSwitch::setup() {
	if (this->parent_->get_protocol_commandset() == 0x25) {
		...
		if (this->buzzer_alarm_switch_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->led_alarm_switch_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->charge_current_limiter_switch_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->charge_mosfet_switch_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
		...
		if (this->discharge_mosfet_switch_ != nullptr && this->parent_->get_bms_mode() == BmsType.BMS_TYPE_MASTER) {
