...
class PaceBmsSwitch : public Component {
 public:
  ...
  void set_buzzer_alarm_switch(PaceBmsSwitchImplementation* buzzer_switch) { this->buzzer_switch_ = buzzer_switch; request_status_information_callback_ = true; }
  void set_led_alarm_switch(PaceBmsSwitchImplementation* led_switch) { this->led_switch_ = led_switch; request_status_information_callback_ = true; }
