...
public:
	...
	public:
		enum StatusInformation_Warning1
		{
			...
			W1_CurrentLimitSwitchFailure = (1 << 7),
			W1_DischaringSwitchFailure = (1 << 6),
			W1_ChargingSwitchFailure = (1 << 5),
			W1_CellVoltageDifferenceSensingFailure = (1 << 4),
			W1_PowerSwitchFailure = (1 << 3),
			W1_CurrentSensingFailure = (1 << 2),
			W1_TemperatureSensingFailure = (1 << 1),
			W1_VoltageSensingFailure = (1 << 0),
		};
		enum StatusInformation_Warning2
		{
			W2_PackLowVoltageProtection = (1 << 7),
			W2_PackLowVoltageWarning = (1 << 6),
			W2_PackOverVoltageProtection = (1 << 5),
			W2_PackOverVoltageWarning = (1 << 4),
			W2_CellLowVoltageProtection = (1 << 3),
			W2_CellLowVoltageWarning = (1 << 2),
			W2_CellOverVoltageProtection = (1 << 1),
			W2_CellOverVoltageWarning = (1 << 0),
		};
		enum StatusInformation_Warning3
		{
			W3_DischargingLowTemperatureProtection = (1 << 7),
			W3_DischargingLowTemperatureWarning = (1 << 6),
			W3_DischargingHighTemperatureProtection = (1 << 5),
			W3_DischargingHighTemperatureWarning = (1 << 4),
			W3_ChargingLowTemperatureProtection = (1 << 3),
			W3_ChargingLowTemperatureWarning = (1 << 2),
			W3_ChargingHighTemperatureProtection = (1 << 1),
			W3_ChargingHighTemperatureWarning = (1 << 0),
		};
		enum StatusInformation_Warning4
		{
			W4_ReservedWarning4Bit8 = (1 << 7),
			W4_Heating = (1 << 6),
			W4_ComponentHighTemperatureProtection = (1 << 5),
			W4_ComponentHighTemperatureWarning = (1 << 4),
			W4_AmbientLowTemperatureProtection  = (1 << 3),
			W4_AmbientLowTemperatureWarning = (1 << 2),
			W4_AmbientHighTemperatureProtection = (1 << 1),
			W4_AmbientHighTemperatureWarning = (1 << 0),
		};
		enum StatusInformation_Warning5
		{
			W5_OutputShortCircuitLock = (1 << 7),
			W5_TransientOverCurrentLock = (1 << 6),
			W5_OutputShortCircuitProtection = (1 << 5),
			W5_TansientOverCurrentProtection = (1 << 4),
			W5_DischargeOverCurrentProtection = (1 << 3),
			W5_DischargeOverCurrentWarning = (1 << 2),
			W5_ChargeOverCurrentProtection = (1 << 1),
			W5_ChargeOverCurrentWarning = (1 << 0),
		};
		enum StatusInformation_Warning6
		{
			W6_InternalWarning6Bit8 = (1 << 7),
			W6_OutputConnectionFailure = (1 << 6),
			W6_OutputReverseConnectionProtection = (1 << 5),
			W6_CellLowVoltageChargingForbidden = (1 << 4),
			W6_RemaingCapacityProtection = (1 << 3),
			W6_RemaingCapacityWarning = (1 << 2),
			W6_IntermittentPowerSupplementWaiting = (1 << 1),
			W6_ChargingHighVoltageProtection = (1 << 0),
		};
	...
	public:
		...
		{
			BE_BalanceEventReservedBit8 = (1 << 7),
			BE_DischargeMosFaultAlarm = (1 << 6),
			BE_ChargeMosFaultAlarm = (1 << 5),
			BE_CellVoltageDifferenceAlarm = (1 << 4),
			BE_BalanceEventReservedBit4 = (1 << 3),
			BE_BalanceEventReservedBit3 = (1 << 2),
			BE_BalanceEventReservedBit2 = (1 << 1),
			BE_BalanceEventBalancingActive = (1 << 0),
		};
		enum StatusInformation_VoltageEvent
		{
			VE_PackUnderVoltageProtect = (1 << 7),
			VE_PackUnderVoltageAlarm = (1 << 6),
			VE_PackOverVoltageProtect = (1 << 5),
			VE_PackOverVoltageAlarm = (1 << 4),
			VE_CellUnderVoltageProtect = (1 << 3),
			VE_CellUnderVoltageAlarm = (1 << 2),
			VE_CellOverVoltageProtect = (1 << 1),
			VE_CellOverVoltageAlarm = (1 << 0),
		};
		enum StatusInformation_TemperatureEvent
		{
			TE_TemperatureEventReservedBit16 = (1 << 15),
			TE_TemperatureEventReservedBit15 = (1 << 14),
			TE_FireAlarm = (1 << 13),
			TE_MosfetHighTemperatureProtect = (1 << 12),
			TE_EnvironmentLowTemperatureProtect = (1 << 11),
			TE_EnvironmentLowTemperatureAlarm = (1 << 10),
			TE_EnvironmentHighTemperatureProtect = (1 << 9),
			TE_EnvironmentHighTemperatureAlarm = (1 << 8),
			TE_DischargeLowTemperatureProtect = (1 << 7),
			TE_DischargeLowTemperatureAlarm = (1 << 6),
			TE_DischargeHighTemperatureProtect = (1 << 5),
			TE_DischargeHighTemperatureAlarm = (1 << 4),
			TE_ChargeLowTemperatureProtect = (1 << 3),
			TE_ChargeLowTemperatureAlarm = (1 << 2),
			TE_ChargeHighTemperatureProtect = (1 << 1),
			TE_ChargeHighTemperatureAlarm = (1 << 0),
		};
		enum StatusInformation_CurrentEvent
		{
			CE_OutputShortCircuitLockout = (1 << 7),
			CE_DischargeLevel2OverCurrentLockout = (1 << 6),
			CE_OutputShortCircuitProtect = (1 << 5),
			CE_DischargeLevel2OverCurrentProtect = (1 << 4),
			CE_DischargeOverCurrentProtect = (1 << 3),
			CE_DischargeOverCurrentAlarm = (1 << 2),
			CE_ChargeOverCurrentProtect = (1 << 1),
			CE_ChargeOverCurrentAlarm = (1 << 0),
		};
		enum StatusInformation_RemainingCapacity
		{
			RC_RemainingCapacityReservedBit8 = (1 << 7),
			RC_RemainingCapacityReservedBit7 = (1 << 6),
			RC_RemainingCapacityReservedBit6 = (1 << 5),
			RC_RemainingCapacityReservedBit5 = (1 << 4),
			RC_RemainingCapacityReservedBit4 = (1 << 3),
			RC_RemainingCapacityReservedBit3 = (1 << 2),
			RC_RemainingCapacityReservedBit2 = (1 << 1),
			RC_StateOfChargeLow = (1 << 0),
		};
		enum StatusInformation_FetStatus
		{
			FS_FetStatusReservedBit8 = (1 << 7),
			FS_FetStatusReservedBit7 = (1 << 6),
			FS_FetStatusReservedBit6 = (1 << 5),
			FS_FetStatusReservedBit5 = (1 << 4),
			FS_HeaterOn = (1 << 3),
			FS_ChargeCurrentLimiterOn = (1 << 2),
			FS_ChargeMosfetOn = (1 << 1),
			FS_DischargeMosfetOn = (1 << 0),
		};
		enum StatusInformation_SystemStatus
		{
			SS_SystemStatusReservedBit8 = (1 << 7),
			SS_SystemStatusReservedBit7 = (1 << 6),
			SS_SystemStatusReservedBit6 = (1 << 5),
			SS_SystemStatusReservedBit5 = (1 << 4),
			SS_Standby = (1 << 3),
			SS_SystemStatusReservedBit3 = (1 << 2),
			SS_Charging = (1 << 1),
			SS_Discharging = (1 << 0),
		};
